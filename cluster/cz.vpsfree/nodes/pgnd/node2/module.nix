    ...
    osNode = {
      networking = {
        ...
        bird = {
          ...
          bgpNeighbours = {
            v4 = [
              { address = "172.16.251.45"; as = 4200000901; }
              { address = "172.16.250.45"; as = 4200000902; }
            ];
            v6 = [
              { address = "2a03:3b40:42:2:12::1"; as = 4200000901; }
              { address = "2a03:3b40:42:3:12::1"; as = 4200000902; }
            ];
          };
        };
