...
Vps.connect_hook(:create) do |ret, _vps|
...
def get_vps_shaper_limit(vps)
  ...
  limit =
    ...
    when 'Brno'
      ...
      raise "Unsupported location #{location.inspect}"
    end
...
NetworkInterface.connect_hook(:morph) do |ret, netif, _original_kind, target_kind|
